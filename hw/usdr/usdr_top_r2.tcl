...
create_project usdr_r2 $origin_dir/usdr_r2

set proj_dir [get_property directory [current_project]]
set obj [get_projects usdr_r2]
...
add_files -norecurse -fileset $obj $lib_dir/phy
...
upgrade_ip [get_ips blk_mem_gen_usb]
...
set xdc_file [file normalize "$origin_dir/usdr_ucf_r2.xdc"]
