...
set_property PACKAGE_PIN E18            [get_ports rxmix_en ]
...
set_property PACKAGE_PIN H17            [get_ports dcen]
set_property PACKAGE_PIN G17            [get_ports rxsw]
...
set_property PACKAGE_PIN L17            [get_ports txclk_ref]
set_property PACKAGE_PIN K17            [get_ports lms_rst_n]
set_property PACKAGE_PIN N17            [get_ports rxclk_f]
set_property PACKAGE_PIN P17            [get_ports rxd[1]]
set_property PACKAGE_PIN P18            [get_ports fpga_ref]
...
set_property PACKAGE_PIN K2             [get_ports board_rev[0]]

# fake port for TOP module
set_property PULLDOWN      true         [get_ports {board_rev[1]}]
